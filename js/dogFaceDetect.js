...
function onOpenCvReady() {
    cv['onRuntimeInitialized'] = () => {
        ...
        let dogFaceCascadeFile = 'dog_face_haar_cascade.xml'; // path to xml
        utils.createFileFromUrl(dogFaceCascadeFile, dogFaceCascadeFile, () => {
            classifier.load(dogFaceCascadeFile); // in the callback, load the cascade from file 
